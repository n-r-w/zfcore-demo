...
// STDAPI DsoGetOleInsertObjectFromUser(HWND hwndOwner, LPCWSTR pwzTitle, DWORD dwFlags, BOOL fDocObjectOnly,
//    BOOL fAllowControls, BSTR* pbstrResult, UINT* ptype);
...
#ifdef MSO_DEBUG_MODE
#define ODS(fmt, ...)	_debugOutput(fmt, __VA_ARGS__)
#else
#define ODS(fmt, ...) ((void)0)
#endif
...
#define METHOD_PROLOGUE(theClass, localClass)                                                                          \
    theClass* pThis = ((theClass*)(((BYTE*)this) - (size_t) & (((theClass*)nullptr)->m_x##localClass)));               \
