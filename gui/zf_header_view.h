...
class ZCORESHARED_EXPORT HeaderView : public QHeaderView
{
    Q_OBJECT
...
public:
    ...
    //! Отображение автопоиска из View
    void setAutoSearchEnabled(bool b);
...
private:
    HeaderView(const View* view, const DataProperty& dataset_property, Qt::Orientation orientation, QWidget* parent = nullptr);
    ~HeaderView() override;
...
signals:
    ...
    void sg_configMenuRequested(const QPoint& pos, const zf::DatasetConfigOptions& options);
...
private:
    ...
    DatasetConfigOptions _config_options = {DatasetConfigOption::Visible | DatasetConfigOption::Filter | DatasetConfigOption::Export};

    inline static const QString MimeType = "application/x-ZFHeaderView";
